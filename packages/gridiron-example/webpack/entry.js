...
exports.default = function (name) {
  switch (name) {
    ...
    case 'vendor':
      return { vendor: ['expose?React!react', 'expose?ReactDOM!react-dom', 'expose?ReactCSSTransitionGroup!react-addons-css-transition-group', 'expose?shallowCompare!react-addons-shallow-compare']
      };
    default:
