...
/** DATA */
export const STREAM_DATA_START = 'STREAM_DATA_START'
export const STREAM_DATA_META = 'STREAM_DATA_META'
export const STREAM_DATA_RECEIVE= 'STREAM_DATA_RECEIVE'
export const STREAM_DATA_COMPLETE = 'STREAM_DATA_COMPLETE'
