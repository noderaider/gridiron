...
function samp(deps) {
  ...
  return function (_Component) {
    ...
    function Samp() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Samp)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.parseJSON = function () {
