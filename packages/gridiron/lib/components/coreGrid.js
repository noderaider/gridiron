...
function coreGrid(deps) {
  ...
  var AutoSizer = _resolver.AutoSizer;
  var Grid = _resolver.Grid;
  ...
  var CoreGrid = compose({ propTypes: _gridironCore.CoreGrid.PropTypes(React),
    defaultProps: _gridironCore.CoreGrid.DefaultProps(React),
    state: {},
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              function (dimensions) {
                var width = _this.state.width || dimensions.width;
                var height = _this.state.height || dimensions.height || 100;
                ...
                return React.createElement(Grid, {
                  ...
                  className: gridClass,
                  style: gridStyle,
                  width: _this.props.maxWidth || _this.state.width || dimensions.width,
                  height: _this.state.height || dimensions.height || 100,
                  ...
                  cellRenderer: function cellRenderer(_ref8) {
                    ...
                    var datum = row.cellData[col.id];
                    var Cell = row.cells[columnIndex];
                    return React.createElement(Cell, { datum: datum });
                  }
                });
              }
            )
