...
function coreGrid(_ref) {
  ...
  return ReactVirtualized ? require('./react-virtualized/coreGrid').default(_extends({ ReactVirtualized: ReactVirtualized }, rest)) : require('./fixed-data-table/coreGrid').default(_extends({ FixedDataTable: FixedDataTable }, rest));
}