...
function pager() {
  ...
  /** PRE REDUX (CONFIG) */
  var PagerContext = compose({ displayName: 'PagerContext',
    propTypes: propTypes,
  ...
  var PagerFilter = connect(function (state) {
    return { state: state };
  })(compose({ displayName: 'PagerFilter',
