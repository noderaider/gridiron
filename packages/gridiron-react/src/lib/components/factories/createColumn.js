...
export default function createColumn(deps, defaults) {
  const { React, shallowCompare, forms, Pre } = deps
  ...
  return function column () {
    ...
    const Cell = createSub(
      { propTypes:  { styles: PropTypes.object.isRequired
                    , theme: PropTypes.object.isRequired
                    }
      , render() {
          const { checkbox, styles, theme, ...props } = this.props
    ...
    const Footer = createSub({ render() { return <div className="footer" {...this.props} /> } })
