...
import GridMonitorEntryList from './GridMonitorEntryList'
import debounce from 'lodash.debounce'

const { reset, rollback, commit, sweep, toggleAction } = ActionCreators

const styles =
{ container:  { fontFamily: 'monaco, Consolas, Lucida Console, monospace'
              , position: 'relative'
              , overflowY: 'hidden'
              , width: '100%'
              , height: '100%'
...
export default class GridMonitor extends Component {
