...
var _GridMonitorEntryAction = require('./GridMonitorEntryAction');

var _GridMonitorEntryAction2 = _interopRequireDefault(_GridMonitorEntryAction);
...
var dataIsEqual = function dataIsEqual(data, previousData, keyPath) {
  var path = [].concat(_toConsumableArray(keyPath)).reverse().slice(1);

  return getDeepItem(data, path) === getDeepItem(previousData, path);
};

var GridMonitorEntry = function (_Component) {
  _inherits(GridMonitorEntry, _Component);

  function GridMonitorEntry(props) {
    _classCallCheck(this, GridMonitorEntry);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GridMonitorEntry).call(this, props));
  ...
  _createClass(GridMonitorEntry, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_GridMonitorEntryAction2.default, {
  ...
  return GridMonitorEntry;
}(_react.Component);

GridMonitorEntry.propTypes = {
...
exports.default = GridMonitorEntry;